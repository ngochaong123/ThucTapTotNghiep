...
('BK042', 'LỜI NGUYỀN LỖ BAN - TẬP 2', '10567-loi-nguyen-lo-ban-tap-2-1.jpg', 4, 'Phiêu mưu - mạo hiểm', 'Viên Thái Cực', 'Khu B', 'Tiếng việt', '2023-09-18'),
('BK043', 'CHIẾC VƯƠNG MIỆN PTOLEMY', '8738-chiec-vuong-mien-ptolemy-1.jpg', 3, 'Phiêu mưu - mạo hiểm', 'Rick Riordan', 'Khu B', 'Tiếng việt', '2023-09-14'),
...
('BK047', 'Tress of the Emerald Sea', '60531406.jpg', 10, 'Phiêu mưu - mạo hiểm', 'Brandon Sanderson', 'Khu B', 'Tiếng anh', '2023-01-10'),
('BK048', 'SPY×FAMILY 1', '52961491.jpg', 3, 'Phiêu mưu - mạo hiểm', 'Tatsuya Endo', 'Khu B', 'Tiếng anh', '2019-07-14');

INSERT INTO members (member_code, name, email, phone, registration_date, age, avatar_link, country) VALUES
('MEM001', 'John Doe', 'john@example.com', '1234567890', '2024-01-15', 25, 'avatar.jpg', 'United States'),
